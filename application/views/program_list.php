		...
		?>
            <div class="panel panel-default">
                ...
                <div style="padding: 0px 20px 20px 20px">
                    <table class="program-curriculum-list" data-toggle="table" data-toolbar="#leaderboard-controls" data-url="<?php echo base_url("index.php/json/getcurriculums/$program_code"); ?>" data-pagination="false" data-page-list="[5, 10, 20, 50, 100, 200, 500]" data-search="false" data-show-refresh="false">
                        <thead>
                            <tr>
            ...
            <div class="modal fade" id="addCurr<?php echo $program_code; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <form id="form-add-curr-<?php echo $program_code; ?>" data-code="<?php echo $program_code; ?>" class="form-add-curr-year" method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <center>
                                    ...
                                    <button type="button" data-code="<?php echo $program_code; ?>" class="btn-add-curr-year btn btn-primary" data-dismiss="modal">Add</button>
                                </center>
                            </div>
                        </div>
                    </div>
